...
#define ui08 char
		...
		#define communicationUart UART7						//使用的串口(注意是USART还是UART)
		
		//串口对应的复用引脚			
		#define Com_UART_GPIO GPIOE
		#define Com_UART_GPIO_Pin GPIO_Pin_7 | GPIO_Pin_8
		//串口对应的时钟
		#define Com_Periph_GPIO    RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOE,ENABLE)
		#define Com_UART_PeriphClock	RCC_APB1PeriphClockCmd(RCC_APB1Periph_UART7 ,ENABLE)
		//对应的引脚复用映射
		#define Com_UART_GPIOAF_Name GPIO_AF_UART7
		#define Com_UART_GPIO_PinSource_1 GPIO_PinSource7
		#define Com_UART_GPIO_PinSource_2 GPIO_PinSource8	
		//串口的中断通道
		#define Com_UART_IRQn	UART7_IRQn
		//串口的中断服务函数名
		#define Com_UseUART_IRQHandler	UART7_IRQHandler()
