...
#define ui08 char
		...
		//串口对应的复用引脚			
		#define Com_UART_GPIO GPIOG
		#define Com_UART_GPIO_Pin GPIO_Pin_14 | GPIO_Pin_9
		//串口对应的时钟
		#define Com_Periph_GPIO   RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOG,ENABLE)
		#define Com_UART_PeriphClock	RCC_APB2PeriphClockCmd(RCC_APB2Periph_USART6 ,ENABLE)
		//对应的引脚复用映射
		#define Com_UART_GPIOAF_Name GPIO_AF_USART6
		#define Com_UART_GPIO_PinSource_1 GPIO_PinSource14
		#define Com_UART_GPIO_PinSource_2 GPIO_PinSource9	
		//串口的中断通道
